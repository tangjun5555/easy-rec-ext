...
python -m easy_rec_ext.main --pipeline_config_path=deep_v1.json --task_type=train_and_evaluate \
  --train_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171130.csv \
  --eval_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171203_1w.csv
python -m easy_rec_ext.main --pipeline_config_path=deep_v1.json --task_type=train_and_evaluate \
  --train_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171201.csv \
  --eval_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171203_1w.csv
python -m easy_rec_ext.main --pipeline_config_path=deep_v1.json --task_type=train_and_evaluate \
  --train_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171202.csv \
  --eval_input_path=${easy_rec_ext_data_dir}/sample_quarter_20171203_1w.csv
echo "完成模型训练"
...
python evaluate_model.py --model_pb_path=deep_v1/export/${version} \
  ...
  --eval_sample_path=${easy_rec_ext_data_dir}/sample_quarter_20171203.csv \
